...
class Classifier(nn.Module):
    def __init__(self):
        ...
        self.fc = nn.Sequential(Linear_layer(256,1028, do_dropout=True, do_batchnorm=True, dropout_rate=0.25),
                                Linear_layer(1028,256, do_dropout=True, do_batchnorm=True, dropout_rate=0.25),
                                Linear_layer(256,10, do_activation=False) # No activation function in last layer since the softmax in already implement in CrossEntropy
                                )
